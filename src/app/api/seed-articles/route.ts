...
console.log(factorial(5)); // Output: 120</code></pre>`,
  ...
  },
  {
    ...
    content: `<h2>Troubleshooting the TechBlog Mobile App</h2>
    <p>Having issues with the TechBlog mobile app? Here are common problems and their solutions.</p>
    
    <h3>App Won't Load or Crashes</h3>
    <h4>Try these steps in order:</h4>
    <ol>
      <li><strong>Force close and restart the app</strong>
        <ul>
          <li>iOS: Double-tap home button, swipe up on TechBlog</li>
          <li>Android: Use recent apps button, swipe away TechBlog</li>
        </ul>
      </li>
      ...
      <li><strong>Update the app</strong>
        <ul>
          <li>Check App Store or Google Play for updates</li>
        </ul>
      </li>
      <li><strong>Clear app cache (Android only)</strong>
        <ul>
          <li>Settings > Apps > TechBlog > Storage > Clear Cache</li>
        </ul>
      </li>
    ...
    <h3>Login Issues</h3>
    <p>Can't sign in to your account?</p>
    <ul>
      <li>Verify your username and password</li>
      <li>Check if caps lock is on</li>
      <li>Try logging in through the website</li>
      <li>Reset your password if needed</li>
      <li>Ensure you're using the correct authentication method</li>
    </ul>
    
    <h3>Sync Issues</h3>
    <p>Content not syncing between devices?</p>
    <ul>
      <li>Check your internet connection</li>
      <li>Sign out and back in to your account</li>
      <li>Force refresh by pulling down on lists</li>
      <li>Check if you're logged into the same account</li>
    </ul>
    
    <h3>Performance Issues</h3>
    <p>App running slowly?</p>
    <ul>
      ...
      <li>Switch to a faster internet connection</li>
    </ul>
    
    <h3>Notification Issues</h3>
    <p>Not receiving notifications?</p>
    <ol>
      <li><strong>Check app notification settings</strong>
        <ul>
          <li>iOS: Settings > Notifications > TechBlog</li>
          <li>Android: Settings > Apps > TechBlog > Notifications</li>
        </ul>
      </li>
      <li><strong>Check in-app notification preferences</strong></li>
      <li><strong>Ensure "Do Not Disturb" is off</strong></li>
      <li><strong>Check your device's notification settings</strong></li>
    </ol>
    
    <h3>System Requirements</h3>
    <p><strong>iOS:</strong> iOS 13.0 or later</p>
    <p><strong>Android:</strong> Android 6.0 (API level 23) or later</p>
    ...
    <ul>
      ...
      <li>Describe the exact steps that lead to the problem</li>
      <li>Include any error messages you see</li>
    </ul>`,
    category: "troubleshooting",
    slug: "mobile-app-troubleshooting",
    tags: ["mobile", "app", "troubleshooting", "bugs"],
    author: "TechBlog Team",
    views: 287,
    published: true
  }
...
export async function POST() {
  try {
    ...
    return NextResponse.json(
      { success: false, error: 'Failed to seed articles' },
      { status: 500 }
    )
  }
}
